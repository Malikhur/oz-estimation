...
export const metadata = {
  ...
  title: {
    default: 'OZ Estimation | Professional Construction Cost Estimation Services',
    template: '%s | OZ Estimation',
  },
  description: 'OZ Estimation provides accurate, professional construction cost estimation services for residential, commercial, and industrial projects across the USA. Get precise takeoffs, detailed cost breakdowns, and reliable bid support within 24-48 hours.',
  keywords: [
  ...
  openGraph: {
    title: 'OZ Estimation | Professional Construction Cost Estimation Services',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'OZ Estimation - Professional Construction Cost Estimation Services',
        type: 'image/svg+xml',
      },
    ],
  },
